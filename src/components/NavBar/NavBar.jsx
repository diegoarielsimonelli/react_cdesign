...
const NavBar = () => {
  ...
  return (
    <Navbar collapseOnSelect expand="lg" bg="danger" variant="danger" className='navBarContainer'>
      <Navbar.Brand as={Link} to="/" className='brand mx-5 mb-1'>C-Design</Navbar.Brand>
